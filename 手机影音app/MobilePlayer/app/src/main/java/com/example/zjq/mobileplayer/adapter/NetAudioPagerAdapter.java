...
public class NetAudioPagerAdapter extends BaseAdapter {
    ...
    public int getItemViewType(int position) {
        ...
        String type = listBean.getType();//video,text...
        int itemViewType = -1;
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        int itemViewType = getItemViewType( position );//得到type
...
*/
    ...
    private void bindData(int itemViewType, ViewHolder viewHolder, NetAudioPagerData.ListBean mediaItem) {
        switch (itemViewType) {
            case TYPE_VIDEO://视频
                bindData1(viewHolder, mediaItem);
            ...
            case TYPE_IMAGE://图片
                ...
                if(mediaItem.getImage() != null &&  mediaItem.getImage().getBig()!= null&&mediaItem.getImage().getBig().size() >0){
                    ...
                    requestOptions.override(mediaItem.getImage().getThumbnail_width(),mediaItem.getImage().getThumbnail_height());
            ...
            case TYPE_GIF://gif
                ...
                Glide.with(context).load(mediaItem.getGif().getImages().get(0)) .apply( requestOptions ).into(viewHolder.iv_image_gif);
    ...
    private void bindData1(ViewHolder viewHolder, NetAudioPagerData.ListBean mediaItem) {
